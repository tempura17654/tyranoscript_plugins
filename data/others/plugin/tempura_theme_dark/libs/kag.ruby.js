...
TYRANO.kag.ruby.createRubyTag = {
    ...
    center: function (conf, str, text) {
        ...
        return ''
        + '<span class="ruby_str'  + this.kag.stat.ruby_no + '" style="display:inline-block;text-indent:0;position:relative;white-space:nowrap;line-height:' + conf.line_height + '; width:' + conf.str_width + '; font-size:' + conf.str_size + ';left:' + conf.str_x + ';">' + str
    ...
    justify: function (conf, str, text) {
        ...
        // B-d) ルビの幅が本文の幅より小さい場合
            ...
            return ''
            + '<span class="ruby_str'  + this.kag.stat.ruby_no + '" style="display:inline-block;text-indent:0;position:relative;white-space:nowrap;line-height:' + conf.line_height + '; width:' + conf.str_width + '; font-size:' + conf.str_size + ';">' + str
    ...
    justifyInvert: function (conf, str, text) {
        ...
        this.kag.ruby.convertConf(conf, true);
        return ''
        + '<span class="ruby_str'  + this.kag.stat.ruby_no + '" style="display:inline-block;text-indent:0;position:relative;white-space:nowrap;line-height:' + conf.line_height + '; width:' + conf.str_width + '; letter-spacing:' + conf.letter_spacing + '; font-size:' + conf.str_size + ';">' + str
