...
window.TM = {
  ...
  currentHtml: "",
  currentText: "",
  glyphUrl:  "./data/others/plugin/tempura_theme_dark/img/nextpage.gif",
  cssUrl:    "./data/others/plugin/tempura_theme_dark/libs/test_message.css",
  sampleUrl: "./data/others/plugin/tempura_theme_dark/libs/test_message.ks",
...
TM.appendGlyph = function () {
  ...
  //this.messageArea.append("<img src='" + this.glyphUrl + "' style='height: 0.8em;'/>");
