...
[macro name=glink_after]
  [cm]
  [free layer=0 name=glink time=300]
[endmacro]
...
[macro name=showglink2]
  ...
  [image name=glink layer=0 x=2340 y=170 storage=../others/plugin/tempura_theme_dark/img/gradient.png width=600 height=220]
  [glink name=glink color=aiyoku x=2340 y=220 width=600 text=&tf.glinks[0].text target=&tf.glinks[0].target storage=&tf.glinks[0].storage]
  [glink name=glink color=aiyoku x=2340 y=305 width=600 text=&tf.glinks[1].text target=&tf.glinks[1].target storage=&tf.glinks[1].storage]
  [showglink_anim]
[endmacro]

[macro name=showglink3]
  [layopt           layer=0 visible=true]
  [image name=glink layer=0 x=2340 y=90 storage=../others/plugin/tempura_theme_dark/img/gradient.png width=600 height=300]
  [glink name=glink color=aiyoku x=2340 y=140 width=600 text=&tf.glinks[0].text target=&tf.glinks[0].target storage=&tf.glinks[0].storage]
  [glink name=glink color=aiyoku x=2340 y=225 width=600 text=&tf.glinks[1].text target=&tf.glinks[1].target storage=&tf.glinks[1].storage]
  [glink name=glink color=aiyoku x=2340 y=315 width=600 text=&tf.glinks[2].text target=&tf.glinks[2].target storage=&tf.glinks[2].storage]
  [showglink_anim]
[endmacro]

[macro name=showglink4]
  [layopt           layer=0 visible=true]
  [image name=glink layer=0 x=2340 y=70 storage=../others/plugin/tempura_theme_dark/img/gradient.png width=600 height=380]
  [glink name=glink color=aiyoku x=2340 y=120 width=600 text=&tf.glinks[0].text target=&tf.glinks[0].target storage=&tf.glinks[0].storage]
  [glink name=glink color=aiyoku x=2340 y=205 width=600 text=&tf.glinks[1].text target=&tf.glinks[1].target storage=&tf.glinks[1].storage]
  [glink name=glink color=aiyoku x=2340 y=285 width=600 text=&tf.glinks[2].text target=&tf.glinks[2].target storage=&tf.glinks[2].storage]
  [glink name=glink color=aiyoku x=2340 y=365 width=600 text=&tf.glinks[3].text target=&tf.glinks[3].target storage=&tf.glinks[3].storage]
  [showglink_anim]
[endmacro]
